...
layout = html.Div([
    ...
    dmc.Alert("Observe equilíbrio entre o que entra no sistema e o que segue para destino final.", title="O que esta análise responde?", color="ifsc-green", variant="light", icon=DashIconify(icon="akar-icons:info"), mb="md"),
